...
func TestUser_Delete(t *testing.T) {
	...
	if err == nil {
		t.Error("retrieved user who was suppesed to be deleted")
	}
}
...
func TestToken_Insert(t *testing.T) {
	...
	if err != nil {
		t.Error("errir inserting token: ", err)
	}
}
...
var authData = []struct{
	...
	{"invalid_length", "abcdefghijklmnopqrstuvwxyz", "a@here.com", true, "token of wrong length token accepted as valid"},
