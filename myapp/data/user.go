...
// User is the type of user table
type User struct {
...
// error. Note that an error is only returned if something goes wrong (since an invalid password is
// not an error -- it's just the wrong password)
